...
public class ObjectiveMarkerUI_Stage4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool lightsOn = carlightController != null && carlightController.HeadlightsAreOn();

        markerRect.gameObject.SetActive(lightsOn && target != null);

        if (distanceText != null)
            distanceText.gameObject.SetActive(lightsOn && target != null);
